...
$seoTitle = 'Above / Under | KND Arena';
$seoDesc  = 'Above/Under — predict if the next number will be above or under. Coming soon to KND Arena.';
    ...
    <div class="row justify-content-center">
      <div class="col-md-6 text-center">
        <div class="glass-card-neon p-5">
          ...
          <h2 class="glow-text mb-3"><i class="fas fa-arrows-alt-v me-2"></i>Above / Under</h2>
          <p class="text-white-50 mb-4"><?php echo t('arena.card_aboveunder_desc', 'Predict if the next number will be above or under the threshold. Fast rounds, pure probability.'); ?></p>
