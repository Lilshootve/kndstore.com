<?php
/** Form for Text2Img - same fields/IDs as labs/text-to-image.php */
?>
<p class="ln-editor-subtitle small mb-2" id="labs-cost-label"><?php echo t('labs.cost_label', 'Cost: 3 KP'); ?></p>
<p class="text-white-50 small mb-2" id="labs-balance-after"></p>
<form id="labs-comfy-form" class="labs-form" method="post" action="#" onsubmit="return false;">
  ...
  <p class="text-white-50 small mb-0" id="labs-microcopy-private"><?php echo t('labs.images_stored', 'Your images are private. Stored for 30 days.'); ?></p>
</form>
