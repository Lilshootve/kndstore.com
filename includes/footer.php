...
function generateFooter() {
    ...
    $footer .= '                            <ul class="list-unstyled">' . "\n";
    $footer .= '                                <li class="mb-3"><a href="/knd-labs.php" class="text-decoration-none" style="opacity: 0.8;"><i class="fas fa-microscope me-2" style="color: var(--knd-neon-blue);"></i>' . t('footer.tools.knd_labs', 'KND Labs') . '</a></li>' . "\n";
    ...
    $footer .= '                                <li class="mb-3"><a href="/triposr-3d.php" class="text-decoration-none" style="opacity: 0.8;"><i class="fas fa-cube me-2" style="color: var(--knd-neon-blue);"></i>' . t('footer.tools.triposr_3d', 'Imagen → 3D') . '</a></li>' . "\n";
    $footer .= '                            </ul>' . "\n";
    $footer .= '                        </div>' . "\n";
    $footer .= '                        ' . "\n";
    $footer .= '                        <div class="col-md-6">' . "\n";
