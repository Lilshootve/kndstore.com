...
function generateFooter() {
    ...
    $footer .= '                                                        <h6 class="mt-4 mb-3">' . t('footer.payments.title') . '</h6>' . "\n";
                            ...
                            $footer .= '                                <div class="me-3 mb-3"><i class="fab fa-cc-paypal fa-2x" style="color: var(--knd-electric-purple);" title="PayPal"></i></div>' . "\n";
                            $footer .= '                                <div class="me-3 mb-3"><i class="fab fa-cc-visa fa-2x" style="color: var(--knd-electric-purple);" title="Visa"></i></div>' . "\n";
                            $footer .= '                                <div class="me-3 mb-3"><i class="fas fa-wallet fa-2x" style="color: var(--knd-electric-purple);" title="Binance Pay"></i></div>' . "\n";
                            $footer .= '                                <div class="me-3 mb-3"><i class="fas fa-university fa-2x" style="color: var(--knd-electric-purple);" title="Bank Transfer / ACH / Wire"></i></div>' . "\n";
                            $footer .= '                            </div>' . "\n";
    $footer .= '                        </div>' . "\n";
    $footer .= '                    </div>' . "\n";
    $footer .= '                </div>' . "\n";
