...
function generateNavigation() {
    ...
    $labsActive = in_array($current_page, ['knd-labs.php', 'ai-tools.php', 'triposr-3d.php', 'labs-text-to-image.php', 'labs-upscale.php', 'labs-consistency.php', 'labs-character-lab.php', 'labs-texture-lab.php', 'labs-jobs.php', 'labs-job.php']) || (strpos($phpSelf, '/labs/') !== false);
    $nav .= '                <li class="nav-item">' . "\n";
