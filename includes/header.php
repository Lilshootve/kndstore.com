...
function generateColorPanel() {
    ...
    $panel .= '            </div>' . "\n";
    $panel .= '            <p>Tecnología orgánica con vibra hacker y futurista.</p>' . "\n";
    $panel .= '        </div>' . "\n";
    $panel .= '        ' . "\n";
    $panel .= '        <div class="color-theme" data-theme="nature-green">' . "\n";
    $panel .= '            <h4>Verde Naturaleza</h4>' . "\n";
    $panel .= '            <div class="color-preview">' . "\n";
    ...
    $panel .= '            </div>' . "\n";
    $panel .= '            <p>Verde orgánico, equilibrio natural y calma digital.</p>' . "\n";
    $panel .= '        </div>' . "\n";
    $panel .= '        ' . "\n";
    $panel .= '        <div class="color-theme" data-theme="fire-red">' . "\n";
    $panel .= '            <h4>Fuego Solar</h4>' . "\n";
    $panel .= '            <div class="color-preview">' . "\n";
    ...
    $panel .= '            </div>' . "\n";
    $panel .= '            <p>Energía intensa con matices rosados, solares y ácidos.</p>' . "\n";
    $panel .= '        </div>' . "\n";
    $panel .= '        ' . "\n";
    ...
    $panel .= '            </div>' . "\n";
    $panel .= '            <p>Elegancia cósmica, lujo solar y contraste profundo.</p>' . "\n";
    $panel .= '        </div>' . "\n";
    $panel .= '        ' . "\n";
    $panel .= '        <div class="color-theme" data-theme="neon-pink">' . "\n";
    $panel .= '            <h4>Rosa Perlado</h4>' . "\n";
    $panel .= '            <div class="color-preview">' . "\n";
    ...
    $panel .= '            </div>' . "\n";
    $panel .= '            <p>Tonos suaves, futurismo elegante y estética premium.</p>' . "\n";
    $panel .= '        </div>' . "\n";
    $panel .= '        ' . "\n";
